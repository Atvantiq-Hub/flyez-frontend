      ...
      <div className="premium-container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 w-full flex items-center justify-center h-[440px] md:h-[480px] relative select-none">
            ...
            {/* Left Card - Wings / Sky */}
            <div className="w-[34%] h-[310px] md:h-[340px] rounded-2xl overflow-hidden border-4 border-[#fafaf9] shadow-lg -rotate-6 translate-x-8 mt-8 transition-all duration-500 hover:rotate-0 hover:scale-110 hover:translate-x-1 hover:z-20 hover:shadow-2xl group cursor-pointer shrink-0">
              <img
            ...
            <div className="w-[42%] h-[390px] md:h-[420px] rounded-3xl overflow-hidden border-4 border-[#fafaf9] shadow-2xl z-10 transition-all duration-500 hover:scale-106 hover:shadow-2xl group cursor-pointer shrink-0">
              <img
